        ...
        settings = {
          basedpyright = {
            ...
            analysis = {
              ...
              typeCheckingMode = "standard", -- set this to "off" (or one of the other 4 levels of strictness) if you don't want it to type check, can also uncomment the above ignore = {"*"} line for only LSP feats
